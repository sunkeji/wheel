...
import com.skj.wheel.album.activity.ShowAllPhotoActivity;
...
public class FolderAdapter extends BaseAdapter {
    ...
    public Object getItem(int position) {
        return AlbumActivity.contentList.get(position);
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (path.contains("android_hybrid_camera_default"))
            ...
            cache.displayBmp(holder.imageView, item.thumbnailPath, item.imagePath, callback, mContext);
        }
        // 为封面添加监听
