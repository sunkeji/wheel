...
import com.skj.wheel.wheel.model.CityModel;
import com.skj.wheel.wheel.model.DistrictModel;
import com.skj.wheel.wheel.model.LocalAreaBean;
import com.skj.wheel.wheel.model.ProvinceModel;
...
public class CityPicker implements CanShow, OnWheelChangedListener {
     ...
     * Color.BLACK
     */
    private String cancelTextColorStr = "#ea5513";


    /**
     * Color.BLUE
     */
    private String confirmTextColorStr = "#ea5513";
...
//        initProvinceDatas(context);
    ...
    protected void initProvinceData(Context context) {
        ...
        if (provinceList != null && !provinceList.isEmpty()) {
            ...
            List<LocalAreaBean.RootBean.CitiesBean> cityList = provinceList.get(0).getCities();
            if (cityList != null && !cityList.isEmpty()) {
                mCurrentCityName = cityList.get(0).getCity();
                List<LocalAreaBean.RootBean.CitiesBean.AreasBean> districtList = cityList.get(0).getAreas();
